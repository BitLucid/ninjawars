...
class MessagesController{
	...
	public function sendPersonal(){
		...
		if($target_id){
			if ((bool)$target_id) {
					Message::create(['send_from'=>$char_id, 'send_to'=>$target_id, 'message'=>$message, 'type'=>$type]);
					$message_sent_to = $to;
	...
	public function viewClan(){
		...
		$parts = array_merge($this->configure(), 
				['messages'=>$messages, 'message_count'=>$message_count, 'pages'=>$pages, 
				'current_page'=>$current_page, 'current_tab'=>$current_tab, 'has_clan'=>$has_clan]);
