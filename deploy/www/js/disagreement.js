...
$(function () {
    ...
    var attackable =
        typeof attacking_possible !== 'undefined' ? attacking_possible : false;
    console.log(attackable ? 'Attacking enabled.' : 'No attacking this target');
    $('#kick_form').submit(function () {
        return window.confirm('Are you sure you want to kick this player?');
    });
