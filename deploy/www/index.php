...
<?php } /* End of login/out conditional display.*/ ?>
        ...
        <div id="menu-info">
          <span class="signup-link" <?=$display_when_logged_out;?>>
            <a target="main" href="<?=WEB_ROOT?>signup.php?referrer=<?php echo $referrer; ?>">Create a Ninja!</a> |
          </span>
...
<!-- End of stats Section -->
          ...
          <div id="music" class="boxes passive">
            <div class="box-title">
              <a href="#" class="show-hide-link" onclick="toggle_visibility('music-player');">Music <img class="show-hide-icon" src="images/show_and_hide.png" alt="+/-"> </a>
            </div>
          ...
          <div id="links" class="boxes passive">
            <div class="box-title">
              <a href="#" class="show-hide-link" onclick="toggle_visibility('links-menu');">Links <img class="show-hide-icon" src="images/show_and_hide.png" alt="+/-"> </a>
            </div>
            <ul id="links-menu">
