...
if ($messenger == 1) {
	...
	if ($to == "clansend") {
		...
		$sql->Query("SELECT uname FROM clan_player JOIN players ON player_id = _player_id WHERE _clan_id = ".$clan->getID());
	...
	echo "A messenger takes your message and will deliver your mail <br> From: ", out($username), " <br>TO: ", out($to), " <br>Message: ", out($message), "<br><br>\n";
