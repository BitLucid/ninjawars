...
class TestPasswordReset extends PHPUnit_Framework_TestCase {
    ...
    public function testRejectionOfResetsThatDontHaveANewPassword(){
        $this->assertFalse(PasswordResetRequest::reset($this->account_id, null));
    }
    ...
    public function testResetOfpasswordWhenCorrectDataGiven(){
        ...
        var_dump($this->account_id, account_info($this->account_id));
        $this->assertTrue(PasswordResetRequest::reset($this->account_id, 'some_password%FW@G'));
    }
