...
module.exports = function karmaConfig(config) {
    config.set({
        ...
        files: [
            ...
            { pattern: 'deploy/www/js/fight.js', type: 'module', included: true },
            { pattern: 'deploy/www/js/epics.js', type: 'module', included: true },
            { pattern: 'deploy/www/js/homepage.js', type: 'module', included: true },
            { pattern: 'deploy/www/js/intro.js', type: 'module', included: true },
            { pattern: 'deploy/www/js/ninjamaster.js', type: 'module', included: true },
