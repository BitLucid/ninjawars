...
insert into item values (default, 'firescroll', 'Fire Scroll', 175), (default, 'icescroll', 'Ice Scroll', 125), (default, 'speedscroll', 'Speed Scroll', 225), (default, 'stealthscroll', 'Stealth Scroll', 150), (default, 'shuriken', 'Shuriken', 50), (default, 'dimmak', 'Dim Mak', 1000), (default, 'strangeherb', 'Strange Herb', 1000), (default, 'kampoformula', 'Kampo Formula', 3000);
