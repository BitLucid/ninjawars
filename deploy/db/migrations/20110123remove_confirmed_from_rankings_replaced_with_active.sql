drop view rankings;
create view rankings as SELECT player_rank.rank_id, players.player_id, player_rank.score, players.uname, class.class_name, players.level, 
        CASE
            WHEN players.health = 0 THEN 0
            ELSE 1
        END::boolean AS alive, players.days
   FROM player_rank
