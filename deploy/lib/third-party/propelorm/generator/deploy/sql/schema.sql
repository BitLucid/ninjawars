...
(
    ...
    CONSTRAINT "account_players__player_id_key1" UNIQUE ("_player_id")
);
...
(
    ...
    CONSTRAINT "clan_player__player_id_key1" UNIQUE ("_player_id")
);
...
(
    ...
    "_player_id" INTEGER NOT NULL,
    "score" INTEGER,
    PRIMARY KEY ("rank_id","_player_id")
);
...
(
    ...
    "resurrection_time" INTEGER DEFAULT (round((random() * (7)3) NOT NULL,
...
(
    ...
    "player_id" INTEGER NOT NULL,
    "settings_store" TEXT,
    PRIMARY KEY ("setting_id","player_id")
);
