...
abstract class BaseEvents extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'deploy\\model\\EventsPeer';
    ...
    public function setEventId($v)
    {
        ...
        if ($this->event_id !== $v) {
            $this->event_id = $v;
            $this->modifiedColumns[] = EventsPeer::EVENT_ID;
        }
    ...
    public function setSendTo($v)
    {
        ...
        if ($this->send_to !== $v) {
            $this->send_to = $v;
            $this->modifiedColumns[] = EventsPeer::SEND_TO;
        }
    ...
    public function setSendFrom($v)
    {
        ...
        if ($this->send_from !== $v) {
            $this->send_from = $v;
            $this->modifiedColumns[] = EventsPeer::SEND_FROM;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[] = EventsPeer::MESSAGE;
        }
    ...
    public function setUnread($v)
    {
        ...
        if ($this->unread !== $v) {
            $this->unread = $v;
            $this->modifiedColumns[] = EventsPeer::UNREAD;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EventsPeer::DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->send_to = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->send_from = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->message = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->unread = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            ...
            return $startcol + 6; // 6 = EventsPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->event_id) {
            try {
                $stmt = $con->query("SELECT nextval('events_event_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->event_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(EventsPeer::EVENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '"event_id"';
        }
        if ($this->isColumnModified(EventsPeer::SEND_TO)) {
            $modifiedColumns[':p' . $index++]  = '"send_to"';
        }
        if ($this->isColumnModified(EventsPeer::SEND_FROM)) {
            $modifiedColumns[':p' . $index++]  = '"send_from"';
        }
        if ($this->isColumnModified(EventsPeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"message"';
        }
        if ($this->isColumnModified(EventsPeer::UNREAD)) {
            $modifiedColumns[':p' . $index++]  = '"unread"';
        }
        if ($this->isColumnModified(EventsPeer::DATE)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setUnread($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventsPeer::EVENT_ID)) $criteria->add(EventsPeer::EVENT_ID, $this->event_id);
        if ($this->isColumnModified(EventsPeer::SEND_TO)) $criteria->add(EventsPeer::SEND_TO, $this->send_to);
        if ($this->isColumnModified(EventsPeer::SEND_FROM)) $criteria->add(EventsPeer::SEND_FROM, $this->send_from);
        if ($this->isColumnModified(EventsPeer::MESSAGE)) $criteria->add(EventsPeer::MESSAGE, $this->message);
        if ($this->isColumnModified(EventsPeer::UNREAD)) $criteria->add(EventsPeer::UNREAD, $this->unread);
        if ($this->isColumnModified(EventsPeer::DATE)) $criteria->add(EventsPeer::DATE, $this->date);
    ...
    {
        $criteria = new Criteria(EventsPeer::DATABASE_NAME);
        $criteria->add(EventsPeer::EVENT_ID, $this->event_id);
