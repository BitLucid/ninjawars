...
class ShrineController extends AbstractController
{
    ...
    public const FREE_RES_KILL_LIMIT  = 25;
    public const HEAL_POINT_COST      = 1;
    public const RES_COST_TURNS       = 10;
    public const RES_COST_KILLS       = 1;
    public const CURE_COST_GOLD       = 100;
    public const RES_COST_TYPE_FREE   = 1;
    public const RES_COST_TYPE_KILL   = 2;
    public const RES_COST_TYPE_TURN   = 3;
    ...
    private function _resurrect($p_player)
    {
        if ($p_player->health <= 0) {
            ...
            if ($costType === self::RES_COST_TYPE_KILL) {
                ...
                $p_player->setTurns($p_player->turns - min(self::RES_COST_TURNS, $p_player->turns));
            }
