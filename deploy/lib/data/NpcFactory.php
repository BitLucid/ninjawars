	...
	public static function npcsData(){
		...
		if(defined('DEBUG') && DEBUG){
			$npcs += [
				...
				'kasha'=>['name'=>'Kasha', 'img'=>'kasha.jpg', 'race'=>'yokai', 'traits'=>'demonic'],
				...
				'oni'=>['name'=>'Oni', 'strength'=>5, 'stamina'=>5, 'speed'=>15, 'ki'=>10, 'short'=>'a horned demon', 'img'=>'hokusai-oni.jpg', 'race'=>'oni', 'traits'=>'demonic'],
			];
		}
		return $npcs;
	}
