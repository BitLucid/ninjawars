...
This message is from SysMsg, the AUTOMATED email system for NinjaWars. <br>
	...
	<a href='{$WEB_ROOT}confirm.php?username={$send_name|escape:'url'}&confirm={$confirm}'>Confirm Account</a><br>
	Or paste this link:<br>{$WEB_ROOT}confirm.php?username={$send_name|escape:'url'}&confirm={$confirm} <br>
	into your browser.<br><br>
	
	If you require help use the forums at {$WEB_ROOT}forum/<br>
	or email: {$SUPPORT_EMAIL}<br><br>
