...
<!-- google_ad_section_start -->
    <p>On your way to the foreman's office, you pass by several <a href='attack_npc.php?attacked=1&victim=villager' target='main' id='attack-peasant-link' title='A peasant?  Or a disguised ninja?  Kill one of the peasants.' class='npc'>peasants</a> drenched in sweat from working in the sun all day.</p>
