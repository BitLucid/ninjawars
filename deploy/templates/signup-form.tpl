	...
	<fieldset>
	 <legend>Confirmation Info</legend>
      ...
      <span>
        Please add <strong>{$smarty.const.SYSTEM_EMAIL}</strong> to the safe email senders list of your email account to guarantee you receive your account and confirmation email.  This email address will only be used for confirmation purposes, never spammed, never shared.
      </span>
      </div>
    </fieldset>
