...
<a href='{$templatelite.const.WEB_ROOT}confirm.php?aid={$account_id|escape:'url'}&amp;confirm={$lost_confirm}'>Activate Account</a><br><br>

Or, paste this URL into your browser.<br><br>

{$templatelite.const.WEB_ROOT}confirm.php?aid={$account_id|escape:'url'}&confirm={$lost_confirm}<br><br>
