        ...
        <div class='char-profile'>
            ...
            <div class='char-information'>
                ...
                <div>
                            ...
                            <span class='char-health-number'>
                                <span class='dead' style='display:none'>
                                    <i class="far fa-heart" aria-hidden="true"></i> <span
                                        class='dead-notice'>Dead</span>
                                </span>
                                <span class='alive'>
                                    <i class="fas fa-heart" aria-hidden="true"></i>
                                    <span
                                        class='char-numeric-health health-number'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                </span>
                            </span>
                        </span>
                    </span>
                    <div>
                        <span
                            class='char-status status-b badge skeleton'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    </div>
                </div>
            </div>
        </div>
...
<div id="ninja-enemy" class='solo-box hidden'>
    <form id="enemy-add" action="/enemies/search" method="get" name="enemy_add">
        <div class='input-group'>
            <input id='enemy-match' required=required type="text" maxlength="50" name="enemy_match"
                class="form-control textField" placeholder='Search by ninja name'
                value='{if isset($enemy_match)}{$enemy_match}{/if}'>
