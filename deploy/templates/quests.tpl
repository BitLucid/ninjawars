...
<section>
	...
	<ol>
		{foreach from=$quests item=$a_quest}
			<li>Quest from <a target='main' href='player.php?player_id={$user_id}'>Username Here</a>: Tagline description here <a target='main' href='/quest/view/{$a_quest.quest_id}'>View Quest</a></li>
		{/foreach}
	</ol>
</section>