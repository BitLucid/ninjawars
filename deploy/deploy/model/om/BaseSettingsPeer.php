...
use deploy\model\map\SettingsTableMap;
...
abstract class BaseSettingsPeer
{
    ...
    const OM_CLASS = 'deploy\\model\\Settings';
    ...
    const SETTING_ID = 'settings.setting_id';

    /** the column name for the player_id field */
    const PLAYER_ID = 'settings.player_id';

    /** the column name for the settings_store field */
    const SETTINGS_STORE = 'settings.settings_store';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('SettingId', 'PlayerId', 'SettingsStore', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('settingId', 'playerId', 'settingsStore', ),
        BasePeer::TYPE_COLNAME => array (SettingsPeer::SETTING_ID, SettingsPeer::PLAYER_ID, SettingsPeer::SETTINGS_STORE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('SETTING_ID', 'PLAYER_ID', 'SETTINGS_STORE', ),
        BasePeer::TYPE_FIELDNAME => array ('setting_id', 'player_id', 'settings_store', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('SettingId' => 0, 'PlayerId' => 1, 'SettingsStore' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('settingId' => 0, 'playerId' => 1, 'settingsStore' => 2, ),
        BasePeer::TYPE_COLNAME => array (SettingsPeer::SETTING_ID => 0, SettingsPeer::PLAYER_ID => 1, SettingsPeer::SETTINGS_STORE => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('SETTING_ID' => 0, 'PLAYER_ID' => 1, 'SETTINGS_STORE' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('setting_id' => 0, 'player_id' => 1, 'settings_store' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SettingsPeer::SETTING_ID);
            $criteria->addSelectColumn(SettingsPeer::PLAYER_ID);
            $criteria->addSelectColumn(SettingsPeer::SETTINGS_STORE);
        } else {
            $criteria->addSelectColumn($alias . '.setting_id');
            $criteria->addSelectColumn($alias . '.player_id');
            $criteria->addSelectColumn($alias . '.settings_store');
        }
    }
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getSettingId(), (string) $obj->getPlayerId()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Settings) {
                $key = serialize(array((string) $value->getSettingId(), (string) $value->getPlayerId()));
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(SettingsPeer::SETTING_ID) && $criteria->keyContainsValue(SettingsPeer::SETTING_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(SettingsPeer::SETTING_ID);
            $value = $criteria->remove(SettingsPeer::SETTING_ID);
            if ($value) {
                $selectCriteria->add(SettingsPeer::SETTING_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(SettingsPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(SettingsPeer::PLAYER_ID);
            $value = $criteria->remove(SettingsPeer::PLAYER_ID);
            if ($value) {
                $selectCriteria->add(SettingsPeer::PLAYER_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(SettingsPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(SettingsPeer::SETTING_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(SettingsPeer::PLAYER_ID, $value[1]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                SettingsPeer::removeInstanceFromPool($value);
            }
        }
     ...
     * @return Settings
     */
    public static function retrieveByPK($setting_id, $player_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $setting_id, (string) $player_id));
         if (null !== ($obj = SettingsPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
        ...
        $criteria = new Criteria(SettingsPeer::DATABASE_NAME);
        $criteria->add(SettingsPeer::SETTING_ID, $setting_id);
        $criteria->add(SettingsPeer::PLAYER_ID, $player_id);
