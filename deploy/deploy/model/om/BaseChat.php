...
abstract class BaseChat extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'deploy\\model\\ChatPeer';
    ...
    public function setChatId($v)
    {
        ...
        if ($this->chat_id !== $v) {
            $this->chat_id = $v;
            $this->modifiedColumns[] = ChatPeer::CHAT_ID;
        }
    ...
    public function setSenderId($v)
    {
        ...
        if ($this->sender_id !== $v) {
            $this->sender_id = $v;
            $this->modifiedColumns[] = ChatPeer::SENDER_ID;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[] = ChatPeer::MESSAGE;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ChatPeer::DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->chat_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->sender_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = ChatPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ChatPeer::CHAT_ID)) {
            $modifiedColumns[':p' . $index++]  = '"chat_id"';
        }
        if ($this->isColumnModified(ChatPeer::SENDER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"sender_id"';
        }
        if ($this->isColumnModified(ChatPeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"message"';
        }
        if ($this->isColumnModified(ChatPeer::DATE)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setChatId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ChatPeer::CHAT_ID)) $criteria->add(ChatPeer::CHAT_ID, $this->chat_id);
        if ($this->isColumnModified(ChatPeer::SENDER_ID)) $criteria->add(ChatPeer::SENDER_ID, $this->sender_id);
        if ($this->isColumnModified(ChatPeer::MESSAGE)) $criteria->add(ChatPeer::MESSAGE, $this->message);
        if ($this->isColumnModified(ChatPeer::DATE)) $criteria->add(ChatPeer::DATE, $this->date);
    ...
    {
        $criteria = new Criteria(ChatPeer::DATABASE_NAME);
        $criteria->add(ChatPeer::CHAT_ID, $this->chat_id);
    ...
    /**
     * Generic method to set the primary key (chat_id column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setChatId(NULL); // this is a auto-increment column, so set to default value
        }
    }
