...
<span class="brownHeading">Frequently Asked Questions</span> <br /><p>
...
You can attack another ninja by selecting <a href="combat.php">combat</a> from the left menu then putting a ninja's name into the search, or viewing a <a href="list_all_players.php">list of ninjas</a> on the "player list", then click their name and attack them from their profile page.<hr />
...
You can get a percentage of gold from killing a Ninja(Players), NPCs, or Clicking on <a href="work.php">Work</a> in the Village, which will let you exchange turns for gold. Also, the <a href="doshin.php">Doshin Office</a> keeps a list of ninjas with bounties on their heads. Killing those ninja will get you the bounty as a reward.<hr />

<span class="brownHeading">How do I attack an NPC?</span><br />
Choose the <a href="combat.php">combat</a> link from the menu. Then click an NPC's link.  Most NPCs only give items and gold, not kill points.<hr />
